...
// ==============================================================================
// Funcionalidades Principales (IA / CV)
// ==============================================================================
...
export async function generarCV(
  ...
  cvTexto,
  ofertaTexto,
  palabrasClaveAts = null,
  inclusionesConfirmadas = null,
  instruccionesAdicionales = null,
  instruccionesConfirmadas = false
) {
  ...
  const respuesta = await fetch(`${API_URL}/generar-cv`, {
    ...
    body: JSON.stringify({
      ...
      instrucciones_confirmadas: instruccionesConfirmadas,
    }),
  });
