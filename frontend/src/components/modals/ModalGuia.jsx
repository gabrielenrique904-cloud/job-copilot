      ...
      <div className="bg-white rounded-xl shadow-lg max-w-md w-full max-h-[80vh] overflow-y-auto p-6">
        ...
        <div className="text-gray-700 space-y-5 text-sm">
          ...
          <div>
            ...
            <p>
              Puedes pegar una oferta específica para conocer tu compatibilidad
              o dejar que AI Job Copilot busque automáticamente ofertas recientes
              adaptadas a tu perfil profesional.
            </p>
          </div>
